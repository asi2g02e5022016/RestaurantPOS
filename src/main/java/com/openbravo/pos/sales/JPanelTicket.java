...
public abstract class JPanelTicket extends JPanel implements JPanelView, BeanFactoryApp, TicketsEditor {
    ...
    private SentenceList sentdocumenttypes;
    private ListKeyed taxcategoriescollection;
    private ListKeyed documenttypescollection;
    private ComboBoxValModel taxcategoriesmodel;
    private ComboBoxValModel documenttypesmodel;
...
//      JG 19 Feb 14 unnecessary parse -  jbtnMooring.setVisible(Boolean.valueOf(m_App.getProperties().getProperty("till.marineoption")).booleanValue());
        ...
        sentdocumenttypes = dlSales.getDocumentTypeList();
        
        taxcategoriesmodel = new ComboBoxValModel();    
        documenttypesmodel = new ComboBoxValModel();  
...
// JG May 2013 use Diamond inference
        ...
        java.util.List<TaxCategoryInfo> documenttypeslist = sentdocumenttypes.list();
        documenttypescollection = new ListKeyed<>(documenttypeslist);
        
        taxcategoriesmodel = new ComboBoxValModel(taxcategorieslist);
        documenttypesmodel = new ComboBoxValModel(documenttypeslist);        
        m_jDocType.setModel(documenttypesmodel);
        ...
        /*if (taxesid == null) {
          ...
          if (m_jDocType.getItemCount() > 0) {
                m_jDocType.setSelectedIndex(0);
            }        
...
// JG 19 Feb 14 unnecessary parse -  m_jaddtax.setSelected((Boolean.valueOf(m_App.getProperties().getProperty("till.taxincluded")).booleanValue()));          
        ...
        if (m_App.getAppUserView().getUser().hasPermission("sales.ChangeTaxOptions")) {
            m_jDocType.setVisible(true);
            m_jaddtax.setVisible(true);
        } else {
            m_jDocType.setVisible(false);
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jDocType = new javax.swing.JComboBox();
        ...
        m_jDocType.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        m_jDocType.setFocusable(false);
        m_jDocType.setPreferredSize(new java.awt.Dimension(28, 25));
        m_jDocType.setRequestFocusEnabled(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        jPanel9.add(m_jDocType, gridBagConstraints);
...
// Autologoff after sending to kitchen   
    ...
    private javax.swing.JComboBox m_jDocType;
