...
//  JG 31 Aug 13 - Added DB Defaults
    ...
    private void initComponents() {
        ...
        jButton1.setText("AgilePOS Web site");
...
//  JG 31 Aug 13 - Added DB Defaults
        ...
        if ("Apache Derby Embedded".equals(jcboDBDriver.getSelectedItem())) {
            ...
            jtxtDbURL.setText("jdbc:derby://localhost:1527/agilepos");
            ...
            jtxtDbDriverLib.setText(new File(new File(dirname), "lib/mysql-connector-java-5.1.26-bin.jar").getAbsolutePath());
            jtxtDbDriver.setText("com.mysql.jdbc.Driver");
            jtxtDbURL.setText("jdbc:mysql://localhost:3306/agilepos");
            ...
            jtxtDbURL.setText("jdbc:oracle:thin://localhost:1521/agilepos");
            ...
            jtxtDbURL.setText("jdbc:postgresql://localhost:5432/agilepos");            
        } else {
