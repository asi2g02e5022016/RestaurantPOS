...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Emepleado', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Administrator', 'admin', '0', TRUE, NULL);
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('-1', 'piso.jpg', 0, NULL);
...
INSERT INTO TAXCUSTCATEGORIES (ID, NAME) VALUES ('EXCENTO','Excento');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', 'Producto No Grabable');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', 'Producto Grabable');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'No grabable', '000', NULL, NULL, 0, FALSE, 3);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'Grabable', '001', NULL, NULL, 0.13, FALSE, 2);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('002', 'Excento', '001', 'EXCENTO', NULL, 0, FALSE, 1);
...
INSERT INTO LOCATIONS(ID, NAME,ADDRESS) VALUES('0', 'Local', NULL);
...
CREATE TABLE DOCUMENT_TYPE (ID varchar(255) NOT NULL,NAME varchar(255) NOT NULL, PRIMARY KEY (ID));

insert into DOCUMENT_TYPE(ID, NAME) VALUES('1','TICKET');
insert into DOCUMENT_TYPE(ID, NAME) VALUES('2','FACTURA');
insert into DOCUMENT_TYPE(ID, NAME) VALUES('3','CCF');
